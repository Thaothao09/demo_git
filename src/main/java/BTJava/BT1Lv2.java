...
public class BT1Lv2 {
    public static void main (String[] args){
        ...
        if (thuNhap <= 5000000) {
            ...
            thuePhaiTra = 5000000 * 0.05 + 5000000 * 0.1 + 8000000 * 0.15 + 14000000 * 0.2 + (thuNhap - 3200000);
        } else if (thuNhap <= 80000000) {
            thuePhaiTra = 5000000 * 0.05 + 5000000 * 0.1 + 8000000 * 0.15 + 14000000 * 0.2 + 20000000 * 0.25 + (thuNhap - 5200000) * 0.3;
        } else {
            thuePhaiTra = 5000000 * 0.05 + 5000000 * 0.1 + 8000000 * 0.15 + 14000000 * 0.2 + 20000000 * 0.25 + 28000000 * 0.3 + (thuNhap - 8000000) * 0.35;
        }
